...
public class ReservationController {
    ...
    public ResponseEntity<Reservation> create(
        ...
        return ResponseEntity.ok(reservationService.create(reservation, roomId, customerId));
    }
    ...
    public ResponseEntity<Reservation> update(
            ...
            @RequestParam(required = false) Long customerId,
            @RequestBody Reservation reservation) {
        return ResponseEntity.ok(reservationService.update(id, reservation, roomId, customerId));
    }
