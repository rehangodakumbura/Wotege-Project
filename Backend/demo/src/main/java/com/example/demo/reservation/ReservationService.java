...
public class ReservationService {
    ...
    public Reservation create(Reservation payload, Long roomId, Long customerId) {
    ...
    public Reservation update(Long id, Reservation payload, Long roomId, Long customerId) {
